...
export default function TestDashboardPage() {
  const totalNetWorth = 125000;
  const totalChange24h = 2500;
  const totalChangePercent = 2.04;
      ...
      <div className="container mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 space-y-8 pb-12">
        <div className="flex flex-col gap-4 md:flex-row md:items-center md:justify-between">
          <div className="space-y-1">
            ...
            <p className="text-muted-foreground">Testing sidebar layout issue</p>
          </div>
          <Button
            size="lg"
            ...
            <div className="relative z-10 flex flex-col h-full justify-between">
              <div>
                ...
                <div className="flex items-baseline gap-4">
                  ...
                  <div className="flex items-center gap-1.5 px-3 py-1 rounded-full text-sm font-medium backdrop-blur-md bg-emerald-500/20 text-emerald-300">
          ...
          <div className="grid grid-cols-1 gap-6">
            ...
            >
              ...
              <div className="flex-1 flex flex-col justify-center">
                ...
                <div className="mt-3">
                  <span className="text-3xl font-bold text-white">+5.32%</span>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            {[1, 2, 3].map((i) => (
              <motion.div
                ...
                className="rounded-3xl border border-white/5 bg-white/5 backdrop-blur-xl p-6 hover:border-white/10 transition-colors"
              >
                <div className="flex items-center gap-3 mb-4">
                  ...
                  <div>
                    <h3 className="font-semibold text-white">Portfolio {i}</h3>
                    <p className="text-xs text-muted-foreground">3 assets</p>
                  </div>
                </div>
                <div className="flex justify-between items-end">
                  <div>
                    <p className="text-2xl font-bold text-white">${(25000 * i).toLocaleString()}</p>
                    <p className="text-sm text-emerald-400">+{(1.5 * i).toFixed(2)}%</p>
                  </div>
                </div>
              </motion.div>
            ))}
