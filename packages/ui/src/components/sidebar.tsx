  ...
  return (
    ...
    >
      ...
      <div
        ...
        className={cn(
          "relative w-64 h-full bg-transparent transition-[width] duration-200 ease-linear",
      ...
      <div
        ...
        className={cn(
          "fixed top-0 bottom-0 z-10 hidden h-svh w-64 transition-[left,right,width] duration-200 ease-linear md:flex",
          side === "left"
