  ...
  return (
    ...
    >
      <div className="flex flex-col space-y-2 text-center mb-6">
        <h1 className="text-2xl font-serif font-light text-white tracking-tight">Create account</h1>
        <p className="text-sm text-zinc-400">Start tracking your portfolio today</p>
      </div>
      ...
      <div className="space-y-6">
        ...
        <div className="relative">
          ...
          <div className="relative flex justify-center text-[10px] uppercase tracking-widest font-medium">
            <span className="bg-[#09090b] px-3 text-zinc-500">Or create with email</span>
          </div>
        </div>
