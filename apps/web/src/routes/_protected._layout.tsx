    ...
    return (
        <div className="flex h-screen flex-col bg-[#0a0a0b]">
            <header className="flex items-center justify-between border-b border-white/6 px-8 py-4">
                ...
                <div className="flex items-center gap-4">
                    ...
                    <nav className="flex items-center gap-2 text-sm">
                        <Link className="text-zinc-400 hover:text-white" to="/">Home</Link>
                        <span className="text-zinc-700">/</span>
                        <Link className="text-zinc-400 hover:text-white" to="/history">History</Link>
                        <span className="text-zinc-700">/</span>
                        <Link className="text-zinc-400 hover:text-white" to="/analytics">Analytics</Link>
                        <span className="text-zinc-700">/</span>
                        <Link className="text-zinc-400 hover:text-white" to="/settings">Settings</Link>
                    </nav>
                    <div className="h-6 w-px bg-white/8" />
                    <div className="flex items-center gap-3">
            ...
            <footer className="border-t border-white/6 px-8 py-4">
                <p className="text-xs text-zinc-600">Finsight – Portfolio Management Platform</p>
            </footer>
        </div>
    );
}
