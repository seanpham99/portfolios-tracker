  ...
  return (
    <Card className="relative overflow-hidden">
      <CardHeader className="flex flex-row items-center gap-4 pb-2">
        <div className="flex items-center justify-center w-12 h-12 rounded-lg bg-muted text-foreground">
          {EXCHANGE_LOGOS[exchange]}
        </div>
        <div className="flex-1">
          <CardTitle className="text-lg">{EXCHANGE_NAMES[exchange]}</CardTitle>
      ...
      <CardContent className="pt-2">
        <div className="flex items-center justify-between">
          ...
          {isConnected && connection.apiKeyMasked && (
            <p className="text-xs text-muted-foreground">
